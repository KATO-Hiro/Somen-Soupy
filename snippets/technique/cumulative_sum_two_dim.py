...
# Verified
# https://atcoder.jp/contests/tessoku-book/submissions/43927673
# https://atcoder.jp/contests/typical90/submissions/43928031

"""
Usage:

size = 10**3  # FIXME: Update value if needs.
...
for _ in range(q):
    ...
    x1 -= 1
    y1 -= 1
    ans = c.query(x1, y1, x2, y2)

    # 0-indexed.
    ans = c.query(x1, y1, x2 + 1, y2 + 1)
"""
